...
Partial Public Class T300124
    ...
    Public Function GetData() As IEnumerable(Of Indicator)
        Return New List(Of Indicator)() From { _
            New Indicator() With { _
                .Value = 5, _
                .WarningMessage = "It's ok", _
                .NeedAlert = False _
            }, _
            New Indicator() With { _
                .Value = 75, _
                .WarningMessage = "Possible dangerous", _
                .NeedAlert = True _
            }, _
            New Indicator() With { _
                .Value = 790, _
                .WarningMessage = "Dangerous", _
                .NeedAlert = True _
            }, _
            New Indicator() With { _
                .Value = 12000, _
                .WarningMessage = "Extremely dangerous", _
                .NeedAlert = True _
            } _
        }
    End Function
